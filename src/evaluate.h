...
public:
    ...
    static int EvaluateMaterial(const Board& board) {
        ...
        for (int pieceType = 0; pieceType < 6; pieceType++) {
            ...
            int blackPieces = __builtin_popcountll(board.bitboards[pieceType + 6]);
    ...
    static int EvaluatePosition(const Board& board) {
        ...
        for (int pieceType = 0; pieceType < 6; pieceType++) {
            ...
            while (pieces) {
                ...
                switch (pieceType) {
                    case 0: score += PAWN_TABLE[square]; break;
                    case 1: score += KNIGHT_TABLE[square]; break;
                    case 2: score += BISHOP_TABLE[square]; break;
                    case 3: score += ROOK_TABLE[square]; break;
                    case 4: score += QUEEN_TABLE[square]; break;
                    case 5: 
                        score += endgame ? KING_END_GAME[square] : KING_MIDDLE_GAME[square];
                        break;
                }
            }
        }
        ...
        for (int pieceType = 6; pieceType < 12; pieceType++) {
            ...
            while (pieces) {
                ...
                switch (pieceType - 6) {
                    case 0: score -= PAWN_TABLE[flippedSquare]; break;
                    case 1: score -= KNIGHT_TABLE[flippedSquare]; break;
                    case 2: score -= BISHOP_TABLE[flippedSquare]; break;
                    case 3: score -= ROOK_TABLE[flippedSquare]; break;
                    case 4: score -= QUEEN_TABLE[flippedSquare]; break;
                    case 5: 
                        score -= endgame ? KING_END_GAME[flippedSquare] : KING_MIDDLE_GAME[flippedSquare];
                        break;
                }
            }
        }
